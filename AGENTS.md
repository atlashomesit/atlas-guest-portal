...
- **Feature work:** Backend roadmap and execution workflow live in **atlas-api** — see `atlas-api/docs/ATLAS-HIGH-VALUE-BACKLOG.md` and `atlas-api/docs/ATLAS-FEATURE-EXECUTION-PROMPT.md` when changes span API and guest frontend.
