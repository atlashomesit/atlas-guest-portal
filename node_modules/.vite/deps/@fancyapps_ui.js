...
var t2 = function(n10, i9 = void 0) {
  return !n10 || n10 === document.body || i9 && n10 === i9 ? null : e(n10) ? n10 : t2(n10.parentElement, i9);
};
...
var a = 0;
function c() {
  let a8 = i.Initializing, f3 = o.Ease, l8 = 0, g = 0, p2 = c.Easings.Linear, m3 = 500, d3 = 0, b3 = 0, S = 0, h3 = 0, y3 = 1 / 0, E3 = 0.01, R2 = 0.01, M3 = false, j2 = {}, w2 = null, v3 = {}, O2 = {}, C = {}, L = 0, I2 = 0, D2 = r.Loop, z2 = c.Easings.Linear;
  const N2 = /* @__PURE__ */ new Map();
  function V(n10, ...t10) {
    for (const e11 of N2.get(n10) || []) e11(...t10);
  }
  function q2(n10) {
  ...
  const F = { getState: function() {
    ...
    return O2 = n10, F;
  }, repeat: function(n10, t10 = 0, e11 = r.Loop, i9) {
    ...
    return n2(v3, O2) || (a8 = i.Initializing, j2 = Object.assign({}, v3), s.add(this), u || (u = window.requestAnimationFrame(e4)), q2(n10)), F;
  }, pause: function() {
    ...
    if (f3 === o.Ease) {
      s11 = t3(0, g / m3, 1), u5 = 1 === s11;
      const t10 = D2 === r.Reverse ? z2 : p2;
      for (const n10 in v3) v3[n10] = j2[n10] + (O2[n10] - j2[n10]) * t10(s11);
    }
    if (f3 === o.Spring) {
      const t10 = 1e-3 * e11;
      let i9 = 0;
      for (const e12 in v3) {
        ...
        let s12 = C[e12];
        s12 = t3(-1 * Math.abs(y3), s12, Math.abs(y3));
        const u6 = s12 * b3 * h3;
    ...
    a8 = i.Destroyed, w2 && (clearTimeout(w2), w2 = null), j2 = v3 = O2 = {}, s.delete(this);
  } };
  return F;
}
c.destroy = () => {
...
function t5(t10, n10) {
  const o9 = [], s11 = e5(t10) ? t10[n10] : t10 instanceof MouseEvent && ("changedTouches" === n10 || "mouseup" !== t10.type) ? [t10] : [];
  for (const e11 of s11) o9.push({ x: e11.clientX, y: e11.clientY, ts: Date.now() });
  return o9;
}
function n3(e11) {
  return t5(e11, "touches");
}
function o2(e11) {
  return t5(e11, "targetTouches");
}
function s2(e11) {
  return t5(e11, "changedTouches");
}
function i2(e11) {
...
var f = (e11, t10) => {
  ...
  function S(e12) {
    const t11 = r2(m3), n10 = r2(E3), o9 = t11 && n10 ? t11 / n10 : 0, s11 = Math.abs(Y) > Math.abs(j2) ? Y : j2, i9 = { srcEvent: f3, isPanRecognized: w2, isSwipeRecognized: y3, firstTouch: p2, previousTouch: E3, currentTouch: m3, deltaX: L, deltaY: P, offsetX: D2, offsetY: X, velocityX: Y, velocityY: j2, velocity: s11, angle: k3, axis: v3, scale: o9, center: h3 };
    for (const t12 of O2.get(e12) || []) t12(i9);
  }
  function q2(e12) {
    const t11 = e12.target, n10 = e12.composedPath()[0], o9 = g.ignore.join(","), s11 = (e13) => e13 && (e13.matches(o9) || e13.closest(o9));
    if (s11(t11) || s11(n10)) return false;
  }
  function C(e12) {
    const t11 = Date.now();
  ...
  function I2(e12) {
    if (false === q2(e12)) return;
    if ("undefined" != typeof MouseEvent && e12 instanceof MouseEvent) {
      if (l) return;
    } else l = true;
    if ("undefined" != typeof MouseEvent && e12 instanceof MouseEvent) {
      if (!e12.buttons || 0 !== e12.button) return;
      c2(e12);
    }
  ...
  function F(e12) {
    if (f3 = e12, !p2.length) return;
    const t11 = o2(e12), n10 = s2(e12);
    if (x2 = t11.length, h3 = i2(n10), n10.length && C(i2(n10)), E3 = [...m3], m3 = [...t11], p2 = [...t11], x2 > 0) S("end"), w2 = false, y3 = false, R2 = [];
    else {
...
var E = (c5, b3 = {}, E3 = {}) => {
  ...
  function H2(e11, ...t10) {
    ...
    for (const e12 of n10) e12 && e12 instanceof Function && e12(je, ...t10);
    "*" !== e11 && H2("*", e11, ...t10);
  }
  function $(e11) {
    if (!W()) return;
    ...
    if (r7 === v.Zoom) {
      ...
      if (o9 - k < (t11 ? 200 : 45)) return void h(e11);
      k = o9;
      const n10 = ne(), a9 = se();
      if (m(c6) < m(n10) && m(l8) <= m(n10) ? (j += Math.abs(s11), c6 = n10) : m(c6) > m(a9) && m(l8) >= m(a9) ? (j += Math.abs(s11), c6 = a9) : (j = 0, c6 = t3(n10, c6, a9)), j > 7) return;
    }
    switch (h(e11), r7) {
      case v.Pan:
  ...
  function _2(e11) {
    ...
    if (!n(i9) || e11.defaultPrevented) return;
  ...
  function N2() {
    var e11;
    c5 && (s4(c5, "is-loading"), null === (e11 = c5.querySelector(".f-spinner")) || void 0 === e11 || e11.remove());
  }
  function V() {
    if (!c5 || !O2) return;
    ...
    p(O2) && (O2.setAttribute("width", e11 + ""), O2.setAttribute("height", t10 + "")), S && (s4(S, "has-error"), p(O2) && (S.setAttribute("width", e11 + ""), S.setAttribute("height", t10 + ""), S.style.aspectRatio = `${e11 / t10 || ""}`)), F = c().on("start", ((e12, t11) => {
      ...
      if (R2 = Object.assign(Object.assign({}, y), e12), Q() || !I2("bounds") || ye() || z2.scale > R2.scale || z2.scale < oe()) return void de();
      ...
      let d3 = false;
      (o9 && l8 || n11 && r7) && (z2.x = t3(t11.x[0], z2.x, t11.x[1]), d3 = true), (a8 && c6 || s11 && u5) && (z2.y = t3(t11.y[0], z2.y, t11.y[1]), d3 = true), d3 && F && F.spring({ tension: 94, friction: 17, maxSpeed: 555 * z2.scale, restDelta: 0.1, restSpeed: 0.1, velocity: F.getCurrentVelocities() }).from(R2).to(z2).start(), de();
    })).on("end", (() => {
  ...
  function ee(e11) {
    ...
    return d3 = t3(l8.x[0], d3, l8.x[1]), f3 = t3(l8.y[0], f3, l8.y[1]), { x: d3, y: f3 };
  }
  ...
  function le() {
    ...
    if (!I2("bounds")) return;
    if (!F) return;
    const e11 = ne(), t10 = se(), n10 = t3(e11, z2.scale, t10);
    if (z2.scale < e11 - 0.01 || z2.scale > t10 + 0.01) return void ue(v.ZoomTo, { scale: n10 });
    if (F.isRunning()) return;
    if (ye()) return;
    const o9 = re(n10);
    z2.x < o9.x[0] || z2.x > o9.x[1] || z2.y < o9.y[0] || z2.y > o9.y[1] ? (z2.x = t3(o9.x[0], z2.x, o9.x[1]), z2.y = t3(o9.y[0], z2.y, o9.y[1]), F.spring({ tension: 170, friction: 17, restDelta: 1e-3, restSpeed: 1e-3, maxSpeed: 1 / 0, velocity: F.getCurrentVelocities() }), F.from(R2).to(z2).start()) : de();
  }
  function ce(e11) {
    var t10;
    if (!W()) return;
    const n10 = be(), o9 = ye(), i9 = xe(), a8 = we(), s11 = ge(), r7 = he();
    s5(S, "is-fullsize", a8), s5(S, "is-expanded", i9), s5(S, "is-dragging", o9), s5(S, "can-drag", n10), s5(S, "will-zoom-in", s11), s5(S, "will-zoom-out", r7);
  ...
  function ue(e11, t10) {
    var n10;
    if (!(e11 && c5 && O2 && F && W())) return;
    if (e11 === v.Swipe && Math.abs(F.getCurrentVelocities().scale) > 0.01) return;
    ...
    let p2 = t10.center;
    t10.srcEvent && (p2 = i2(s2(t10.srcEvent)));
    ...
    switch (e11) {
      ...
      case v.MoveDown:
        ...
        } else a8.x = t3(l8.x[0], a8.x + b4, l8.x[1]), a8.y = t3(l8.y[0], a8.y + x2, l8.y[1]);
        break;
      case v.Swipe:
        const e12 = (e13 = 0) => Math.sign(e13) * Math.pow(Math.abs(e13), 1.5);
        a8.x += t3(-1e3, e12(h3), 1e3), a8.y += t3(-1e3, e12(m3), 1e3), m3 && !h3 && (a8.x = t3(l8.x[0], a8.x, l8.x[1])), !m3 && h3 && (a8.y = t3(l8.y[0], a8.y, l8.y[1])), u5.x = h3, u5.y = m3;
        break;
      case v.ZoomTo:
    ...
    if (f3 && (a8.scale = t3(ne() * (f3 ? 0.8 : 1), a8.scale, se() * (f3 ? 1.6 : 1))), Q()) {
      ...
      a8.x = n11 - r7 * a8.scale, a8.y = s11 - u6 * a8.scale, !f3 && I2("bounds") && (l8 = re(a8.scale), a8.x = t3(l8.x[0], a8.x, l8.x[1]), a8.y = t3(l8.y[0], a8.y, l8.y[1]));
    }
    if (e11 === v.Swipe) {
    ...
    } else e11 === v.Pan || f3 ? F.spring({ tension: 900, friction: 17, restDelta: 0.01, restSpeed: 0.01, maxSpeed: 1 }) : F.spring({ tension: 170, friction: 17, restDelta: 1e-3, restSpeed: 1e-3, maxSpeed: 1 / 0, velocity: u5 });
    if (0 === t10.velocity || n2(R2, a8)) R2 = Object.assign({}, a8), z2 = Object.assign({}, a8), F.end(), de(), ce();
    else {
      if (n2(z2, a8)) return;
  ...
  function de() {
    if (!O2 || !S || !C) return;
    const { width: e11, height: t10 } = J();
    Object.assign(S.style, { maxWidth: `min(${e11}px, 100%)`, maxHeight: `min(${t10}px, 100%)` });
    const n10 = (function() {
      const { width: e12, height: t11 } = J(), { width: n11, height: o10 } = K();
      if (!c5) return { x: 0, y: 0, width: 0, height: 0, scale: 0, flipX: 0, flipY: 0, angle: 0, fitWidth: n11, fitHeight: o10, fullWidth: e12, fullHeight: t11 };
  ...
  const je = { canDrag: be, canZoomIn: pe, canZoomOut: me, canZoomToFull: ve, destroy: function() {
    H2("destroy");
    for (const e11 of Object.values(Y)) null == e11 || e11.destroy(je);
    for (const e11 of D2) e11();
    ...
    return P = 0, H2("init"), (function() {
      for (const [e11, t10] of Object.entries(Object.assign(Object.assign({}, E3), X.plugins || {}))) if (e11 && !Y[e11] && t10 instanceof Function) {
        const n10 = t10();
      ...
      if (!c5) return;
      if (s3(c5, e11.container), O2 = c5.querySelector("." + e11.content), !O2) return;
      O2.setAttribute("draggable", "false"), S = c5.querySelector("." + e11.wrapper), S || (S = document.createElement("div"), s3(S, e11.wrapper), O2.insertAdjacentElement("beforebegin", S), S.insertAdjacentElement("afterbegin", O2));
      C = c5.querySelector("." + e11.viewport), C || (C = document.createElement("div"), s3(C, e11.viewport), C.insertAdjacentElement("afterbegin", O2), S.insertAdjacentElement("beforeend", C));
      ...
      if (C && (C.style.visibility = "hidden", I2("protected"))) {
        ...
        s3(e12, "f-panzoom__protected"), C.appendChild(e12);
      }
      H2("initLayout");
    })(), (function() {
      if (c5 && S && !Z) {
      ...
      if (P = 1, c5.classList.add("is-loading"), H2("loading"), A2.src && A2.complete) return void e11();
      (function() {
        if (!c5) return;
        if (null == c5 ? void 0 : c5.querySelector(".f-spinner")) return;
        const e12 = I2("spinnerTpl"), t10 = e2(e12);
    ...
    for (const n10 of e11 instanceof Array ? e11 : [e11]) q2.has(n10) && q2.set(n10, q2.get(n10).filter(((e12) => e12 !== t10)));
    return je;
  }, on: function(e11, t10) {
    for (const n10 of e11 instanceof Array ? e11 : [e11]) q2.set(n10, [...q2.get(n10) || [], t10]);
    return je;
...
var r3 = (t10, ...e11) => {
  ...
  for (let c5 = 0; c5 < n10; c5++) {
    ...
    Object.entries(n11).forEach((([e12, n12]) => {
      ...
      t10[e12] || Object.assign(t10, { [e12]: c6 }), t4(n12) ? Object.assign(t10[e12], r3(t10[e12], n12)) : Array.isArray(n12) ? Object.assign(t10, { [e12]: [...n12] }) : Object.assign(t10, { [e12]: n12 });
    }));
  }
  return t10;
};
...
var t6 = function(t10 = 0, n10 = 0, r7 = 0, c5 = 0, m3 = 0, p2 = false) {
  ...
  return p2 ? c5 < m3 ? t3(c5, s11, m3) : t3(m3, s11, c5) : s11;
};
...
var E2 = (g, x2 = {}, w2 = {}) => {
  ...
  function et(t10, e11 = []) {
    ...
    for (let n11 = 0; n11 < e11.length; n11++) t10 = t10.split(e11[n11][0]).join(e11[n11][1]);
  ...
  function it(t10, ...e11) {
    ...
    for (const t11 of n10) t11 && t11 instanceof Function && t11($t, ...e11);
    "*" !== t10 && it("*", t10, ...e11);
  }
  function ot() {
    var e11, n10;
    ...
    if (l8) for (const [t10, e12] of Object.entries(l8)) window.matchMedia(t10).matches && (r7 += t10, r3(i9, e12));
    if (void 0 === L || r7 !== L) {
      if (L = r7, 0 !== P) {
        ...
        for (const t11 of X) t11.isVirtual && i9.slides.push(t11);
      }
      Ct(), O2 = i9, false !== tt("enabled") && (P = 0, it("init"), (function() {
        for (const [t10, e12] of Object.entries(Object.assign(Object.assign({}, w2), O2.plugins || {}))) if (t10 && !R2[t10] && e12 instanceof Function) {
          const n11 = e12();
        ...
        s3(H2, e12.container);
        const n11 = tt("style");
        if (n11 && t4(n11)) for (const [t10, e13] of Object.entries(n11)) H2.style.setProperty(t10, e13);
        C = H2.querySelector(`.${e12.viewport}`), C || (C = document.createElement("div"), s3(C, e12.viewport), C.append(...e7(H2, `.${e12.slide}`)), H2.insertAdjacentElement("afterbegin", C)), H2.carousel = $t, it("initLayout");
      })(), (function() {
        if (!C) return;
        const t10 = tt("classes") || {};
        X = [], [...e7(C, `.${t10.slide}`)].forEach(((t11) => {
          if (t11.parentElement) {
            const e12 = ht(Object.assign({ el: t11, isVirtual: false }, t11.dataset || {}));
            it("createSlide", e12), X.push(e12);
          }
        })), xt();
        for (const t11 of X) it("addSlide", t11);
        mt(tt("slides"));
        for (const t11 of X) {
          const e12 = t11.el;
          (null == e12 ? void 0 : e12.parentElement) === C && (s3(e12, O2.classes.slide), s3(e12, t11.class), Tt(t11), it("attachSlideEl", t11));
        }
        it("initSlides");
      })(), wt(), P = 1, s3(H2, (tt("classes") || {}).isEnabled || ""), Ht(), ct(), S = c().on("start", (() => {
        M3 && M3.isPointerDown() || (at(), Ht());
      })).on("step", ((t10) => {
        const e12 = F;
        F = t10.pos, F !== e12 && (z2 = false, Ht());
      })).on("end", ((t10) => {
        (null == M3 ? void 0 : M3.isPointerDown()) || (F = t10.pos, S && !D2 && (F < N2 || F > _2) ? S.spring({ clamp: true, mass: 1, tension: 200, friction: 25, velocity: 0, restDelta: 1, restSpeed: 1 }).from({ pos: F }).to({ pos: t3(N2, F, _2) }).start() : z2 || (z2 = true, it("settle")));
      })), rt(), (function() {
        if (!H2 || !C) return;
  ...
  function rt() {
    false === tt("gestures") ? M3 && (M3.destroy(), M3 = void 0) : M3 || (function() {
      ...
      !M3 && false !== t10 && C && (M3 = f(C, t10).on("start", ((t11) => {
        var e11, n10;
        if (!S) return;
        if (false === tt("gestures", t11)) return;
        const { srcEvent: o9 } = t11;
        q2 && e5(o9) && !t2(o9.target) && m2(o9), S.pause(), S.getCurrentVelocities().pos = 0;
        ...
        })(r7)[I2] || 0) * ($ && !q2 ? 1 : -1)), D2 || (F < N2 || F > _2) && S.spring({ clamp: true, mass: 1, tension: 500, friction: 25, velocity: (null === (n10 = S.getCurrentVelocities()) || void 0 === n10 ? void 0 : n10.pos) || 0, restDelta: 1, restSpeed: 1 }).from({ pos: F }).to({ pos: t3(N2, F, _2) }).start(), St();
      })).on("move", ((t11) => {
        var e11, n10;
        if (false === tt("gestures", t11)) return;
        const { srcEvent: o9, axis: s11, deltaX: r7, deltaY: l8 } = t11;
        if (e5(o9) && (null === (e11 = o9.touches) || void 0 === e11 ? void 0 : e11.length) > 1) return;
        const a8 = o9.target, c5 = t2(a8), d3 = c5 ? c5.scrollHeight > c5.clientHeight ? "y" : "x" : void 0;
        if (c5 && (!s11 || s11 === d3)) return;
        if (!s11) return m2(o9), o9.stopPropagation(), void o9.stopImmediatePropagation();
        if ("y" === s11 && !q2 || "x" === s11 && q2) return;
        ...
        false !== tt("gestures", t11) && (null == t11 ? void 0 : t11.axis) === (q2 ? "y" : "x") && s3(C, "is-dragging");
      })).on("panend", ((t11) => {
        false !== tt("gestures", t11) && s4(C, "is-dragging");
      })).on("end", ((t11) => {
        var e11, n10;
        if (false === tt("gestures", t11)) return;
        const { srcEvent: o9, axis: s11, velocityX: r7, velocityY: l8, currentTouch: c5 } = t11;
        if (c5.length > 0 || !S) return;
        const d3 = o9.target, u5 = t2(d3), f3 = u5 ? u5.scrollHeight > u5.clientHeight ? "y" : "x" : void 0, v3 = u5 && (!s11 || s11 === f3);
        q2 && e5(o9) && !t11.axis && At(o9);
        ...
        if (v3 || (b3 += h3 * (m3 ? 5 : 1) * y3), !D2 && (h3 * y3 <= 0 && b3 < N2 || h3 * y3 >= 0 && b3 > _2)) {
          let t12 = 0;
          return Math.abs(h3) > 0 && (t12 = 2 * Math.abs(h3), t12 = Math.min(0.3 * vt(), t12)), b3 = t3(N2 + -1 * t12, b3, _2 + t12), void S.spring({ clamp: true, mass: 1, tension: 380, friction: 25, velocity: -1 * h3, restDelta: 1, restSpeed: 1 }).from({ pos: F }).to({ pos: b3 }).start();
        }
        if (m3 || (null === (e11 = R2.Autoscroll) || void 0 === e11 ? void 0 : e11.isEnabled())) return void (Math.abs(h3) > 10 ? S.spring({ clamp: true, mass: 1, tension: 150, friction: 25, velocity: -1 * h3, restDelta: 1, restSpeed: 1 }).from({ pos: F }).to({ pos: b3 }).start() : S.isRunning() || z2 || (z2 = true, it("settle")));
        if (!m3 && !(null === (n10 = R2.Autoscroll) || void 0 === n10 ? void 0 : n10.isEnabled()) && (!t11.offsetX && !t11.offsetY || "y" === s11 && !q2 || "x" === s11 && q2)) return void Ot(k3, { transition: "tween" });
        let E3 = ut(b3);
        Math.abs(h3) > 10 && E3 === k3 && (E3 += h3 > 0 ? $ && !q2 ? 1 : -1 : $ && !q2 ? -1 : 1), Ot(E3, { transition: "tween", tween: { velocity: -1 * h3 } });
      })).init());
    })(), s5(C, "is-draggable", !!M3 && K.length > 0);
  }
  function lt(t10 = "*") {
    var e11;
    const n10 = [];
    for (const i9 of X) ("*" === t10 || i9.class && i9.class.includes(t10) || i9.el && (null === (e11 = i9.el) || void 0 === e11 ? void 0 : e11.classList.contains(t10))) && n10.push(i9);
  ...
  function ct() {
    var t10, e11;
    if (!H2) return;
    for (const t11 of H2.querySelectorAll("[data-carousel-index]")) t11.innerHTML = k3 + "";
    for (const t11 of H2.querySelectorAll("[data-carousel-page]")) t11.innerHTML = k3 + 1 + "";
    for (const t11 of H2.querySelectorAll("[data-carousel-pages]")) t11.innerHTML = K.length + "";
    ...
    for (const t11 of H2.querySelectorAll("[data-carousel-go-prev]")) t11.toggleAttribute("aria-disabled", !Vt()), Vt() ? t11.removeAttribute("tabindex") : t11.setAttribute("tabindex", "-1");
    for (const t11 of H2.querySelectorAll("[data-carousel-go-next]")) t11.toggleAttribute("aria-disabled", !Dt()), Dt() ? t11.removeAttribute("tabindex") : t11.setAttribute("tabindex", "-1");
    let n10 = false;
    const i9 = null === (e11 = K[k3]) || void 0 === e11 ? void 0 : e11.slides[0];
    i9 && (i9.downloadSrc || "image" === i9.type && i9.src) && (n10 = true);
    for (const t11 of H2.querySelectorAll("[data-carousel-download]")) t11.toggleAttribute("aria-disabled", !n10);
  }
  function dt(t10) {
    var e11;
    t10 || (t10 = null === (e11 = K[k3]) || void 0 === e11 ? void 0 : e11.slides[0]);
    const n10 = null == t10 ? void 0 : t10.el;
    if (n10) for (const e12 of n10.querySelectorAll("[data-slide-index]")) e12.innerHTML = t10.index + 1 + "";
  }
  function ut(t10) {
    var e11, n10, i9;
    ...
    const o9 = pt();
    let s11 = t10;
    D2 ? s11 -= Math.floor((t10 - (null === (e11 = K[0]) || void 0 === e11 ? void 0 : e11.pos)) / o9) * o9 || 0 : s11 = t3(null === (n10 = K[0]) || void 0 === n10 ? void 0 : n10.pos, t10, null === (i9 = K[K.length - 1]) || void 0 === i9 ? void 0 : i9.pos);
  ...
  function mt(t10, e11) {
    ...
    for (const t11 of n10) it("addSlide", t11), bt(t11);
    return lt(G), n10;
  }
  function ht(t10) {
    return (t(t10) || t10 instanceof HTMLElement) && (t10 = { html: t10 }), Object.assign({ index: -1, el: void 0, class: "", isVirtual: true, dim: 0, pos: 0, offset: 0, html: "", src: "" }, t10);
  }
  function bt(t10) {
    let e11 = t10.el;
    if (!t10 || !e11) return;
    const n10 = t10.html ? t10.html instanceof HTMLElement ? t10.html : e2(t10.html) : void 0;
    n10 && (s3(n10, "f-html"), t10.htmlEl = n10, s3(e11, "has-html"), e11.append(n10), it("contentReady", t10));
  }
  function yt(t10) {
    if (!C || !t10) return;
    let e11 = t10.el;
    if (e11) {
      if (e11.setAttribute("index", t10.index + ""), e11.parentElement !== C) {
        let n10;
        s3(e11, O2.classes.slide), s3(e11, t10.class), Tt(t10);
        for (const e12 of X) if (e12.index > t10.index) {
          n10 = e12.el;
          break;
        }
  ...
  function xt() {
    for (let t10 = 0; t10 < X.length; t10++) {
      ...
      n10 && (e11.index !== t10 && Mt(n10), n10.setAttribute("index", `${t10}`)), e11.index = t10;
    }
  }
  function wt() {
    ...
    const r7 = tt("classes");
    if (s5(H2, r7.isLTR, !$), s5(H2, r7.isRTL, $), s5(H2, r7.isHorizontal, !q2), s5(H2, r7.isVertical, q2), s5(H2, r7.hasAdaptiveHeight, tt("adaptiveHeight")), !vt()) return;
    ...
    const d3 = (function() {
      ...
      if (C) {
        ...
        e11.style.display = "block", s3(e11, O2.classes.slide), C.appendChild(e11), t11 = e11.getBoundingClientRect()[I2], e11.remove(), e11 = void 0;
      }
      return t11;
    })();
    for (const n11 of Y) {
    ...
    !(function() {
      ...
      let o10 = 0, s12 = 0;
      for (const n12 of Y) (!K.length || o10 + n12.dim - e11 > 0.05 || s12 >= i10) && (K.push({ index: K.length, slides: [], dim: 0, offset: 0, pos: 0 }), o10 = 0, s12 = 0), null === (t11 = K[K.length - 1]) || void 0 === t11 || t11.slides.push(n12), o10 += n12.dim + Z, s12++;
      const r8 = tt("center"), l9 = tt("fill");
      let c5 = 0;
      for (const t12 of K) {
        t12.dim = (t12.slides.length - 1) * Z;
        for (const e12 of t12.slides) t12.dim += e12.dim;
        t12.offset = c5, t12.pos = c5, false !== r8 && (t12.pos -= 0.5 * (e11 - t12.dim)), l9 && !D2 && n11 > e11 && (t12.pos = t3(0, t12.pos, n11 - e11)), c5 += t12.dim + Z;
      }
      const d4 = [];
      let u5;
      for (const t12 of K) {
      ...
      void 0 !== e11 && (k3 = $t.getPageIndex(e11) || 0), k3 = t3(0, k3, K.length - 1), F = (null === (t11 = K[k3]) || void 0 === t11 ? void 0 : t11.pos) || 0, B2 = F;
  ...
  function Mt(t10) {
    ...
    t10.removeEventListener("animationend", jt), s4(t10, o9.join(" ")), W.delete(n10);
  }
  function St() {
    if (!C) return;
    const t10 = W.size > 0;
    for (const t11 of Y) Mt(t11.el);
    W.clear(), t10 && Ht();
  }
  function jt(t10) {
    var e11;
    "f-" === (null === (e11 = t10.animationName) || void 0 === e11 ? void 0 : e11.substring(0, 2)) && (Mt(t10.target), W.size || (s4(H2, "in-transition"), !z2 && Math.abs($t.getPosition(true) - B2) < 0.5 && (z2 = true, it("settle"))), Ht());
  }
  function At(t10) {
    var e11;
    if (t10.defaultPrevented) return;
    const n10 = t10.composedPath()[0];
    if (n10.closest("[data-carousel-go-prev]")) return m2(t10), void $t.prev();
    if (n10.closest("[data-carousel-go-next]")) return m2(t10), void $t.next();
    const i9 = n10.closest("[data-carousel-go-to]");
    if (i9) return m2(t10), void $t.goTo(parseFloat(i9.dataset.carouselGoTo || "") || 0);
  ...
  function Pt(t10) {
    var e11;
    const n10 = t10.el;
    n10 && (null === (e11 = n10.querySelector(".f-html.is-error")) || void 0 === e11 || e11.remove(), s4(n10, "has-error"));
  }
  function Tt(t10) {
    var e11;
    t10 || (t10 = null === (e11 = K[k3]) || void 0 === e11 ? void 0 : e11.slides[0]);
    ...
    if (s11 && s11 instanceof HTMLElement) {
      if (t10.index !== k3) return;
      if (t(o9) && (s11.innerHTML = et(o9 + "")), o9 instanceof HTMLElement) {
    ...
    !r7 && o9 instanceof HTMLElement && o9.classList.contains("f-caption") && (r7 = o9), r7 || (r7 = document.createElement("div"), s3(r7, "f-caption"), t(o9) ? r7.innerHTML = et(o9 + "") : o9 instanceof HTMLElement && (o9.parentElement && (o9 = o9.cloneNode(true)), r7.append(o9)));
    const l8 = `f-caption-${y2}_${t10.index}`;
    r7.setAttribute("id", l8), r7.dataset.selectable = "true", s3(i9, "has-caption"), i9.setAttribute("aria-labelledby", l8), t10.captionEl = r7, i9.insertAdjacentElement("beforeend", r7);
  }
  function Ot(e11, i9 = {}) {
    var o9, r7;
    ...
    if ((function(t10, e12) {
      var i10, o10, s11, r8;
      if (!(H2 && S && e12 && t(e12) && "tween" !== e12)) return false;
      if ((null === (i10 = K[k3]) || void 0 === i10 ? void 0 : i10.slides.length) > 1) return false;
      const l9 = K.length;
      let u6 = t10 > k3 ? 1 : -1;
      t10 = D2 ? (t10 % l9 + l9) % l9 : t3(0, t10, l9 - 1), $ && (u6 *= -1);
      ...
      if (void 0 === g2 || void 0 === v4 || v4 === g2 || F === m3 || Math.abs(vt() - ((null == p3 ? void 0 : p3.dim) || 0)) > 1) return false;
      z2 = false, S.pause(), St(), s3(H2, "in-transition"), F = B2 = m3;
      const h3 = yt(f4), b3 = yt(p3);
      return at(), h3 && (W.add(v4), h3.style.transform = "", h3.addEventListener("animationend", jt), s4(h3, O2.classes.isSelected), h3.inert = false, s3(h3, `f-${e12}Out to-${u6 > 0 ? "next" : "prev"}`)), b3 && (W.add(g2), b3.style.transform = "", b3.addEventListener("animationend", jt), s3(b3, O2.classes.isSelected), b3.inert = false, s3(b3, `f-${e12}In from-${u6 > 0 ? "prev" : "next"}`)), Ht(), true;
    })(e11, l8)) return;
    e11 = D2 ? (e11 % f3 + f3) % f3 : t3(0, e11, f3 - 1);
    const v3 = (null === (o9 = K[e11 || 0]) || void 0 === o9 ? void 0 : o9.pos) || 0;
    B2 = v3;
    const p2 = S.isRunning() ? S.getEndValues().pos : F;
    if (Math.abs(B2 - p2) < 1) return F = B2, k3 !== e11 && (Tt(), A2 = k3, k3 = e11, ct(), dt(), it("change", k3, A2)), Ht(), void (z2 || (z2 = true, it("settle")));
    if (S.pause(), St(), D2) {
    ...
    false !== l8 && t4(u5) ? S.spring(r3({}, O2.tween, u5)).from({ pos: F }).to({ pos: B2 }).start() : (F = B2, at(), Ht(), z2 || (z2 = true, it("settle")));
  }
  function Rt(t10) {
    var e11;
    let n10 = F;
  ...
  function Ht() {
    ...
    C && l8 && (C.style.height = `${l8}px`), [...e7(C, `.${O2.classes.slide}`)].forEach(((t11) => {
      s5(t11, O2.classes.isSelected, e11.has(t11));
      const n11 = X[parseInt(t11.getAttribute("index") || "-1")];
      if (!n11) return t11.remove(), void Mt(t11);
      const i10 = W.has(n11.index), o9 = J.indexOf(n11) > -1;
      if (n11.isVirtual && !i10 && !o9) return void Et(n11);
      if (t11.inert = !o9, false === s11) return;
      let l9 = n11.pos ? Math.round(1e4 * n11.pos) / 1e4 : 0, a8 = 0, c5 = 0, d3 = 0, f3 = 0;
      i10 || (a8 = q2 ? 0 : $ ? -1 * l9 : l9, c5 = q2 ? l9 : 0, d3 = t6(a8, 0, n11.dim, 0, 100), f3 = t6(c5, 0, n11.dim, 0, 100)), s11 instanceof Function && !i10 ? s11($t, n11, { x: a8, y: c5, xPercent: d3, yPercent: f3 }) : t11.style.transform = a8 || c5 ? `translate3d(${d3}%, ${f3}%,0)` : "";
    })), it("render", n10);
  }
  function Ct() {
    ...
    for (const t10 of Object.values(R2)) null == t10 || t10.destroy();
    R2 = {}, null == M3 || M3.destroy(), M3 = void 0, null == S || S.destroy(), S = void 0;
    for (const [t10, e11] of Object.entries(O2.classes || {})) "container" !== t10 && s4(H2, e11);
    s4(C, "is-draggable");
  }
  function Vt() {
    return D2 || k3 > 0;
  ...
  const $t = { add: function(t10, e11) {
    ...
    return lt(t10), wt(), F = t3(N2, F, _2), Ht(), it("filter", t10), $t;
    ...
    if (void 0 !== t10) {
      for (const e11 of K || []) for (const n10 of e11.slides) if (n10.index === t10) return e11.index;
      return -1;
    }
    return k3;
    ...
    if (!g || !n(g)) throw new Error("No Element found");
    ...
    for (const n10 of t10 instanceof Array ? t10 : [t10]) nt.has(n10) && nt.set(n10, nt.get(n10).filter(((t11) => t11 !== e11)));
    return $t;
  }, on: function(t10, e11) {
    for (const n10 of t10 instanceof Array ? t10 : [t10]) nt.set(n10, [...nt.get(n10) || [], e11]);
    return $t;
  }, prev: function(t10 = {}) {
    return Ot(k3 - 1, t10), $t;
    ...
    const e11 = X[t10];
    return e11 && (it("removeSlide", e11), e11.el && (Mt(e11.el), e11.el.remove(), e11.el = void 0), X.splice(t10, 1), lt(G), wt(), F = t3(N2, F, _2), Ht()), $t;
    ...
    if (n10) {
      ...
      s3(i9, "f-html"), s3(i9, "is-error"), i9.innerHTML = et(e11 || "<p>{{ERROR}}</p>"), t10.htmlEl = i9, s3(n10, "has-html"), s3(n10, "has-error"), n10.insertAdjacentElement("afterbegin", i9), it("contentReady", t10);
    }
    return $t;
  }, showLoading: function(t10) {
    const e11 = t10.el, n10 = null == e11 ? void 0 : e11.querySelector(".f-spinner");
    if (!e11 || n10) return $t;
    const i9 = tt("spinnerTpl"), o9 = e2(i9);
    return o9 && (s3(o9, "f-spinner"), e11.insertAdjacentElement("beforeend", o9)), $t;
  }, version: "6.1.5" };
  return $t;
};
...
var t7 = (t10 = true, e11 = "--f-scrollbar-compensate", s11 = "--f-body-margin", o9 = "hide-scrollbar") => {
  ...
  if (t10) {
    ...
    t11 < 0 && (t11 = 0), l8.style.setProperty(e11, `${t11}px`);
    const n11 = parseFloat(window.getComputedStyle(r7).marginRight);
    n11 && r7.style.setProperty(s11, `${n11}px`), r7.classList.add(o9);
  } else r7.classList.remove(o9), r7.style.setProperty(s11, ""), n10.documentElement.style.setProperty(e11, "");
};
...
var a3 = { tpl: (t10) => `<img class="f-panzoom__content" 
    ${t10.srcset ? 'data-lazy-srcset="{{srcset}}"' : ""} 
    ${t10.sizes ? 'data-lazy-sizes="{{sizes}}"' : ""} 
    data-lazy-src="{{src}}" alt="{{alt}}" />` };
var s6 = () => {
  let s11;
  function l8(e11, o9) {
    const n10 = null == s11 ? void 0 : s11.getOptions().Zoomable;
    let i9 = (t4(n10) ? Object.assign(Object.assign({}, a3), n10) : a3)[e11];
  ...
  function r7() {
    ...
    if (t10.length > 1 || "slide" === (null == s11 ? void 0 : s11.getOption("transition"))) for (const e11 of t10) {
  ...
  function f3(t10, i9) {
    ...
    z2.on("*", ((t11, e11, ...o9) => {
      s11 && ("loading" === e11 && (i9.state = 0), "loaded" === e11 && (i9.state = 1), "error" === e11 && (i9.state = 2, null == s11 || s11.showError(i9, "{{IMAGE_ERROR}}")), s11.emit(`panzoom:${e11}`, i9, ...o9), "ready" === e11 && s11.emit("contentReady", i9), i9.index === (null == s11 ? void 0 : s11.getPageIndex()) && m3());
    })), i9.panzoomRef = z2;
  }
  function u5(t10, e11) {
  ...
  function m3() {
    ...
    if (o9) if (n10) n10.updateControls(o9);
    else for (const t11 of o9.querySelectorAll("[data-panzoom-action]") || []) t11.setAttribute("aria-disabled", ""), t11.setAttribute("tabindex", "-1");
  }
  function p2(t10, ...e11) {
    var o9;
  ...
  return { init: function(t10) {
    ...
    if (s11) {
      ...
      for (const t10 of s11.getSlides()) u5(0, t10);
    }
    s11 = void 0;
  }, execute: p2 };
};
...
var i3 = () => {
  ...
  function o9() {
    ...
    return t4(t11) ? Object.assign(Object.assign({}, e9), t11) : e9;
  }
  function s11(n10) {
    var e11, s12, l9;
  ...
  function g(n10, e11) {
    ...
    if (!s12) return;
    const l9 = s12 ? e11.target.closest(`.${s12}`) : null;
    if (l9) {
  ...
  function v3() {
    ...
    for (const n11 of (null == i9 ? void 0 : i9.getSlides()) || []) null === (o10 = n11.el) || void 0 === o10 || o10.classList.toggle("is-selected", n11.index === s12);
  }
...
var i4 = () => {
  ...
  function d3() {
    ...
    return t4(e11) ? Object.assign(Object.assign({}, s7), e11) : s7;
  }
  function r7(t10) {
    var s11;
    const r8 = t10.el;
      ...
      if (g) {
        if (y3 && g) {
          ...
          d3().showLoading && (null == i9 || i9.showLoading(t10)), r9.addEventListener("load", (() => {
            null == i9 || i9.hideLoading(t10), s4(r9, l2), r9 instanceof HTMLImageElement ? r9.decode().then((() => {
              s4(r9, n5), s3(r9, o4);
            })) : (s4(r9, n5), s3(r9, o4)), m4 || null == i9 || i9.emit("lazyLoad:loaded", t10, r9, g);
          })), r9.addEventListener("error", (() => {
            null == i9 || i9.hideLoading(t10), s4(r9, n5), s3(r9, l2), m4 || null == i9 || i9.emit("lazyLoad:error", t10, r9, g);
...
var l3 = () => {
  ...
  function a8() {
    ...
    return t4(t10) ? Object.assign(Object.assign({}, s8), t10) : s8;
  }
  function u5(e11) {
    if (!r7) return;
    const o9 = `<button data-carousel-go-${e11} tabindex="0" class="f-button is-arrow is-${e11}" title="{{${e11.toUpperCase()}}}">` + a8()[`${e11}Tpl`] + "</button", i10 = e2(r7.localize(o9)) || void 0;
    return i10 && s3(i10, a8()[`${e11}Class`]), i10;
  }
  function c5() {
    var t10;
  ...
  function d3() {
    r7 && false !== r7.getOptions().Arrows && r7.getPages().length > 1 ? (!(function() {
      ...
      t10 && (i9 || (i9 = u5("prev"), i9 && t10.insertAdjacentElement("beforebegin", i9)), l8 || (l8 = u5("next"), l8 && t10.insertAdjacentElement("afterend", l8)), s5(r7.getContainer(), "has-arrows", !(!i9 && !l8)));
...
var v2 = {};
for (const [t10, M3] of Object.entries(o5)) v2[t10] = { tpl: `<button data-panzoom-action="${M3[0]}" class="f-button" title="{{${M3[1]}}}"><svg>${M3[2]}</svg></button>` };
...
var r5 = () => {
  ...
  function u5(e11) {
    ...
    let n10 = (t4(o9) ? Object.assign(Object.assign({}, a4), o9) : a4)[e11];
  ...
  function c5() {
    ...
    for (const t10 of l8.getSlides()) t10.panzoomRef && (b3 = true), (t10.downloadSrc || "image" === t10.type && t10.src) && (m3 = true);
...
var o6 = () => {
  ...
  function u5(e11) {
    ...
    let a9 = (t4(i10) ? Object.assign(Object.assign({}, n6), i10) : n6)[e11];
  ...
  function g() {
    if (!o9 || !a8 || l8 || s11 || i9 || !o9.isSettled() || (function() {
      ...
      for (const t12 of e11) if (0 === t12.state) return true;
      return false;
    })()) return;
    !(function() {
      var t11, n10, i10, a9;
  ...
  function c5() {
    ...
    if (a8) return;
    a8 = true, o9.emit("autoplay:start", u5("timeout")), s3(o9.getContainer(), "has-autoplay"), null === (t10 = o9.getTween()) || void 0 === t10 || t10.on("start", b3);
...
var c3 = () => {
  ...
  function b3(e11) {
    ...
    let o9 = (t4(n10) ? Object.assign(Object.assign({}, u3), n10) : u3)[e11];
  ...
  function y3() {
    ...
    let t10 = 0;
    for (const e11 of c5.getSlides()) e11.thumbSrc && t10++;
  ...
  function C() {
    ...
    for (const n10 of e11) t10.push({ index: n10.index, class: n10.thumbClass, html: T(n10) });
    return t10;
  }
  function T(t10) {
    const e11 = t10.thumb ? t10.thumb instanceof HTMLImageElement ? t10.thumb.src : t10.thumb : t10.thumbSrc || void 0, o9 = void 0 === t10.thumbAlt ? `Thumbnail #${t10.index}` : t10.thumbAlt + "";
    let i9 = b3("thumbTpl");
    return i9 = n4(i9, "{{alt}}", o9), i9 = n4(i9, "{{src}}", e11 + ""), i9 = n4(i9, "{{index}}", `${t10.index}`), i9 = n4(i9, "{{page}}", `${t10.index || 1}`), i9;
  }
  function L(t10) {
    return `<div index="${t10.index || 0}" class="f-thumbs__slide ${t10.class || ""}">${t10.html || ""}</div>`;
  }
  function E3(t10 = false) {
    ...
    s3(f3, o9.container), s3(f3, "f-thumbs"), s3(f3, `is-${b3("type")}`), t10 && s3(f3, "is-hidden");
  }
  function P() {
    if (!f3 || !S()) return;
  ...
  function w2() {
    ...
    const o9 = r3({}, { Sync: { target: c5 }, Lazyload: { preload: 1 }, slides: n10, classes: { container: "f-thumbs", viewport: "f-thumbs__viewport", slide: "f-thumbs__slide" }, center: true, fill: !x2(), infinite: false, dragFree: true, rtl: c5.getOptions().rtl || false, slidesPerPage: (t11) => {
      let e11 = 0;
      return x2() && (!(function() {
        if (!x2()) return;
        if (!f3) return;
  ...
  function $() {
    ...
    null == f3 || f3.classList.toggle("is-syncing", false === (null == c5 ? void 0 : c5.hasNavigated()) || (null === (t10 = null == c5 ? void 0 : c5.getTween()) || void 0 === t10 ? void 0 : t10.isRunning())), R2(), (null === (e11 = null == c5 ? void 0 : c5.getGestures()) || void 0 === e11 ? void 0 : e11.isPointerDown()) && (function() {
      ...
      if (!(c5 && e12 && e12[n10] && t11)) return;
      const l8 = t11.isRunning() ? t11.getCurrentValues().pos : d3.getPosition();
      if (void 0 === l8) return;
      let r7 = e12[n10].pos + i9 * (h3 - v3);
      r7 = t3(e12[0].pos, r7, e12[e12.length - 1].pos), t11.from({ pos: l8 }).to({ pos: r7 }).start();
    })();
  }
  function O2() {
    p2 = true, D2();
  ...
  function _2(t10, e11) {
    var n10;
    d3 ? d3.remove(e11.index) : m3 && (null === (n10 = m3.querySelector(`[index="${e11.index}"]`)) || void 0 === n10 || n10.remove());
  }
  function I2(t10, e11) {
    var n10;
    const o9 = e11.target;
  ...
  function D2(t10 = false) {
    ...
    const n10 = m3.querySelector(`[index="${e11}"]`);
    if (n10) {
  ...
  function R2() {
    ...
    for (const n10 of t10) {
      ...
      o9 = Math.max(-1, Math.min(1, o9)), o9 > -1 && o9 < 1 && (e11 += 0.5 * h3 * (1 - Math.abs(o9))), o9 = Math.round(1e4 * o9) / 1e4, e11 = Math.round(1e4 * e11) / 1e4, t11.style.setProperty("--progress", `${Math.abs(o9)}`), t11.style.setProperty("--shift", `${(null == c5 ? void 0 : c5.isRTL()) ? -1 * e11 : e11}px`), o9 > -1 && o9 < 1 && (e11 += 0.5 * h3 * (1 - Math.abs(o9)));
    }
  }
  ...
  function l8(t10, a8) {
    ...
    if (!l9) {
      if (l9 || ("#" === i10.charAt(0) ? l9 = "inline" : i10.match(/(^data:image\/[a-z0-9+\/=]*,)|(\.((a)?png|avif|gif|jp(g|eg)|pjp(eg)?|jfif|svg|webp|bmp|ico|tif(f)?)((\?|#).*)?$)/i) ? l9 = "image" : i10.match(/\.(pdf)((\?|#).*)?$/i) ? l9 = "pdf" : i10.match(/\.(html|php)((\?|#).*)?$/i) && (l9 = "iframe")), !l9) {
        ...
        t11 && (i10 = `https://maps.google.${t11[1]}/?ll=${(t11[2] ? t11[2] + "&z=" + Math.floor(parseFloat(t11[3])) + (t11[4] ? t11[4].replace(/^\//, "&") : "") : t11[4] + "").replace(/\?/, "&")}&output=${t11[4] && t11[4].indexOf("layer=c") > 0 ? "svembed" : "embed"}`, l9 = "gmap");
      }
      if (!l9) {
        const t11 = i10.match(/(?:maps\.)?google\.([a-z]{2,3}(?:\.[a-z]{2})?)\/(?:maps\/search\/)(.*)/i);
        t11 && (i10 = `https://maps.google.${t11[1]}/maps?q=${t11[2].replace("query=", "q=").replace("api=1", "")}&output=embed`, l9 = "gmap");
      }
  ...
  function o9(e11, l9) {
    "iframe" !== l9.type && "pdf" !== l9.type && "gmap" !== l9.type || (function(e12) {
      ...
      for (const [e13, o11] of Object.entries((function() {
        ...
        return t4(e14) ? Object.assign(Object.assign({}, a6), e14) : a6;
      })().iframeAttr || {})) l10.setAttribute(e13, o11);
      l10.onerror = () => {
      ...
      if (o10.classList.add("f-html"), o10.append(l10), e12.width) {
        let t10 = `${e12.width}`;
        t10.match(/^\d+$/) && (t10 += "px"), o10.style.maxWidth = `${t10}`;
      }
      if (e12.height) {
        let t10 = `${e12.height}`;
        t10.match(/^\d+$/) && (t10 += "px"), o10.style.maxHeight = `${t10}`;
      }
      if (e12.aspectRatio) {
        const t10 = e12.el.getBoundingClientRect();
        o10.style.aspectRatio = `${e12.aspectRatio}`, o10.style[t10.width > t10.height ? "width" : "height"] = "auto", o10.style[t10.width > t10.height ? "maxWidth" : "maxHeight"] = "none";
      }
      e12.contentEl = l10, e12.htmlEl = o10, e12.el.classList.add("has-html"), e12.el.classList.add("has-iframe"), e12.el.classList.add(`has-${e12.type}`), e12.el.prepend(o10), i9.emit("contentReady", e12);
    })(l9);
  }
...
var l5 = () => {
  ...
  function a8() {
    ...
    return t4(e11) ? Object.assign(Object.assign({}, i7), e11) : i7;
  }
  function r7() {
    var t10;
  ...
  const c5 = (t10) => {
    ...
    try {
      ...
      if ("https://player.vimeo.com" === t10.origin) {
        if ("ready" === o9.event) for (let o10 of Array.from((null === (e11 = null == l8 ? void 0 : l8.getContainer()) || void 0 === e11 ? void 0 : e11.getElementsByClassName("f-iframe")) || [])) o10 instanceof HTMLIFrameElement && o10.contentWindow === t10.source && (o10.dataset.ready = "true");
  ...
  function d3(t10, o9) {
    ...
    if (!l9 || "youtube" === l9) {
      ...
      if (t11) {
        const e11 = Object.assign(Object.assign({}, a8().youtube), o9.youtube || {}), s12 = `www.youtube${e11.nocookie ? "-nocookie" : ""}.com`, r8 = n7(i9, e11), c6 = encodeURIComponent(t11[2]);
        o9.videoId = c6, o9.src = `https://${s12}/embed/${c6}?${r8}`, o9.thumb = o9.thumb || `https://i.ytimg.com/vi/${c6}/mqdefault.jpg`, l9 = "youtube";
      }
    }
    if (!l9 || "vimeo" === l9) {
      ...
      if (t11) {
        ...
        o9.videoId = r8, o9.src = `https://player.vimeo.com/video/${r8}?${c6 ? `h=${c6}${s12 ? "&" : ""}` : ""}${s12}`, l9 = "vimeo";
      }
    }
    o9.type = l9;
  }
  function u5(t10, n10) {
    "html5video" === n10.type && (function(t11) {
      if (!l8 || !t11.el || !t11.src) return;
      const { el: n11, src: i9 } = t11;
      if (!n11 || !i9) return;
      const s12 = t11.html5videoTpl || a8().html5videoTpl, r8 = t11.html5videoFormat || a8().html5videoFormat;
      if (!s12) return;
      const c6 = t11.poster || (t11.thumb && t(t11.thumb) ? t11.thumb : ""), d4 = e2(s12.replace(/\{\{src\}\}/gi, i9 + "").replace(/\{\{format\}\}/gi, r8 || "").replace(/\{\{poster\}\}/gi, c6 + ""));
      if (!d4) return;
      const u6 = document.createElement("div");
      u6.classList.add("f-html"), u6.append(d4), t11.contentEl = d4, t11.htmlEl = u6, n11.classList.add(`has-${t11.type}`), n11.prepend(u6), h3(t11), l8.emit("contentReady", t11);
      ...
      for (const [t12, o10] of Object.entries(a8().iframeAttr || {})) e11.setAttribute(t12, o10);
      e11.onload = () => {
        var o10;
      ...
      o9.classList.add("f-html"), o9.append(e11), t11.contentEl = e11, t11.htmlEl = o9, t11.el.classList.add("has-html"), t11.el.classList.add("has-iframe"), t11.el.classList.add(`has-${t11.type}`), t11.el.prepend(o9), h3(t11), l8.emit("contentReady", t11);
    })(n10);
  }
  function m3(t10, e11) {
    var o9, n10;
  ...
  function p2() {
    ...
    (t10 && void 0 !== t10.autoplay ? t10.autoplay : a8().autoplay) && ((function() {
      ...
      if (o9 && "html5video" === (null == e11 ? void 0 : e11.type)) try {
  ...
  function h3(t10) {
    ...
    if (t10 && e11 && ("html5video" === t10.type || "youtube" === t10.type || "vimeo" === t10.type)) {
      if (e11.style.aspectRatio = "", e11.style.width = "", e11.style.height = "", e11.style.maxWidth = "", e11.style.maxHeight = "", t10.width) {
        let o9 = `${t10.width}`;
        o9.match(/^\d+$/) && (o9 += "px"), e11.style.maxWidth = `${o9}`;
      }
      if (t10.height) {
        let o9 = `${t10.height}`;
        o9.match(/^\d+$/) && (o9 += "px"), e11.style.maxHeight = `${o9}`;
      }
      if (t10.aspectRatio) {
        ...
        e11.style.aspectRatio = `${t10.aspectRatio}`, e11.style.width = a9 ? "auto" : "", e11.style.height = a9 ? "" : "auto";
      }
    }
  }
  function v3() {
...
var l6 = () => {
  ...
  function u5(t10) {
    ...
    let o10 = (t4(u6) ? Object.assign(Object.assign({}, n8), u6) : n8)[t10];
...
var u4 = () => {
  ...
  if (!t10) return;
  let o9 = document.querySelector(`[data-slug="${t10}"]`);
  o9 && e10.fromTriggerEl(o9), a7() || (o9 = document.querySelectorAll(`[data-fancybox="${t10}"]`)[n10 - 1], o9 && e10.fromTriggerEl(o9, { startIndex: n10 - 1 })), a7() && o9 && !o9.closest("[inert]") && o9.scrollIntoView({ behavior: "instant", block: "center", inline: "center" });
};
var c4 = () => {
  if (!e10) return;
  if (i8) return;
  const t10 = null == e10 ? void 0 : e10.getInstance(), n10 = null == t10 ? void 0 : t10.getCarousel();
  if (false === (null == t10 ? void 0 : t10.getOptions().Hash)) return;
  const { urlSlug: o9, urlIndex: a8 } = s10();
  if (t10 && n10) {
    const e11 = n10.getSlides();
    for (const t11 of e11 || []) if (o9 === t11.slug || o9 === t11.fancybox && t11.index === a8 - 1) return r6 = false, void n10.goTo(t11.index);
...
var f2 = () => {
  ...
  function u5() {
    ...
    if (!h3) return;
    let p2 = g.slug ? `#${g.slug}` : `#${h3}-${w2}`;
    ((null === (l8 = null === (i9 = t10.getCarousel()) || void 0 === i9 ? void 0 : i9.getPages()) || void 0 === l8 ? void 0 : l8.length) || 0) < 2 && (p2 = `#${h3}`), d4 !== p2 && (a8 = d4), history.scrollRestoration && (e11 = history.scrollRestoration, history.scrollRestoration = "manual"), u6.on("change", c5);
    const y3 = h3 !== f3;
    try {
  ...
  function c5() {
    ...
    if (!e12) return;
    let n10 = e12.slug || e12.fancybox || "", o9 = e12.index + 1, r7 = e12.slug ? `#${e12.slug}` : `#${n10}-${o9}`;
    i8 = true;
    try {
...
f2.startFromUrl = u4, f2.setup = function(n10) {
  e10 || (e10 = n10, e8() && (/complete|interactive|loaded/.test(document.readyState) ? d2() : document.addEventListener("DOMContentLoaded", d2)));
};
...
var O = (e11 = null, t10 = "", n10) => {
  ...
  e11.dataset.animationName = t10, e11.addEventListener("animationend", o9), s3(e11, t10);
};
var R = (e11) => {
...
var B = () => {
  ...
  function te(e11, ...t10) {
    ...
    for (const [t11, o9] of Object.entries($.on || {})) (t11 === e11 || t11.split(" ").indexOf(e11) > -1) && n10.push(o9);
    for (const e12 of n10) e12 && "function" == typeof e12 && e12(Oe, ...t10);
    "*" !== e11 && te("*", e11, ...t10);
  }
  function ne() {
    s4(T, "is-revealing");
    ...
    ve(n10), de(), null === (o9 = n10.el) || void 0 === o9 || o9.addEventListener("click", se), "inline" !== n10.type && "clone" !== n10.type || (function(e12) {
      ...
      if (n11) {
        if (s3(n11, "f-html"), "clone" === e12.type || n11.closest(".fancybox__carousel")) {
          ...
          o10 = o10 ? `${o10}--clone` : `clone-${K}-${e12.index}`, n11.setAttribute("id", o10);
        ...
        e12.htmlEl = n11, s3(e12.el, "has-html"), e12.el.prepend(n11), n11.classList.remove("hidden"), "none" === n11.style.display && (n11.style.display = ""), "none" === getComputedStyle(n11).getPropertyValue("display") && (n11.style.display = n11.dataset.display || "flex"), null == B2 || B2.emit("contentReady", e12);
      } else null == B2 || B2.showError(e12, "{{ELEMENT_NOT_FOUND}}");
      ...
      n11.onreadystatechange = function() {
        if (n11.readyState === XMLHttpRequest.DONE && W === _.Ready) if (null == B2 || B2.hideLoading(e12), e12.state = 1, 200 === n11.status) {
  ...
  function se(e11) {
    if (!be()) return;
    if (W !== _.Ready) return k2(e11), void e11.stopPropagation();
    if (e11.defaultPrevented) return;
    if (!f.isClickAllowed()) return;
  ...
  function re() {
    ...
    !(function() {
      ...
      if (!J("dragToClose") || !B2 || !e12) return;
      if (q2 = f(e12).init(), !q2) return;
      ...
      const c5 = (e13) => {
        ...
        return B2 && !(e5(n11) && (null === (t12 = n11.touches) || void 0 === t12 ? void 0 : t12.length) > 1) && o10 && !t2(o10);
      };
      F = c().on("step", ((t12) => {
        if (T && e12 && W === _.Ready) {
  ...
  function ue() {
    ...
    s5(T, "has-thumbs", (null == t10 ? void 0 : t10.isEnabled()) || false), s5(T, "has-vertical-thumbs", !!t10 && ("scrollable" === t10.getType() || true === (null === (e11 = t10.getCarousel()) || void 0 === e11 ? void 0 : e11.isVertical())));
  }
  function de() {
    if (T) {
      const e11 = (null == B2 ? void 0 : B2.getPages()) || [], t10 = (null == B2 ? void 0 : B2.getPageIndex()) || 0;
      for (const e12 of T.querySelectorAll("[data-fancybox-index]")) e12.innerHTML = t10 + "";
      for (const e12 of T.querySelectorAll("[data-fancybox-page]")) e12.innerHTML = t10 + 1 + "";
      for (const t11 of T.querySelectorAll("[data-fancybox-pages]")) t11.innerHTML = e11.length + "";
    }
  }
  function fe(e11) {
    if (!!e11.composedPath()[0].closest("[data-fancybox-close]")) return void Me(e11);
    if (te("backdropClick", e11), e11.defaultPrevented) return;
  ...
  function ge(e11) {
    ...
    if (te("keydown", e11), e11.defaultPrevented) return;
    const s11 = o9[t10];
    if (s11) switch (s11) {
      case "close":
        Me(e11);
  ...
  function pe(e11) {
    if (!be()) return;
    if (W !== _.Ready) return;
    if (Pe(), e11.defaultPrevented) return;
  ...
  function ve(e11) {
    ...
    if ("auto" === a8 && (a8 = true !== (null === (t10 = null == B2 ? void 0 : B2.getPlugins().Toolbar) || void 0 === t10 ? void 0 : t10.isEnabled())), a8) {
      if (!l8) {
        const t11 = e2(Q(A));
        t11 && (s3(t11, "is-close-button"), e11.closeButtonEl = r8.insertAdjacentElement("afterbegin", t11), s3(n10, "has-close-btn"));
      }
    } else ye(e11);
  }
  function ye(e11) {
    e11.closeButtonEl && (e11.closeButtonEl.remove(), e11.closeButtonEl = void 0), s4(e11.el, "has-close-btn");
  }
  function he(e11) {
    if (!(Y && B2 && 1 === B2.getState() && e11 && e11.index === B2.getOptions().initialPage && e11.el && e11.el.parentElement)) return;
  ...
  function Me(e11, t10) {
    ...
    if (te("shouldClose", a8, e11), a8.defaultPrevented) return;
    if (Le(), e11) {
      if (e11.defaultPrevented) return;
    ...
    if (W = _.Closing, null == F || F.pause(), null == q2 || q2.destroy(), B2) {
      ...
      for (const e12 of B2.getSlides()) {
        ...
        t11 && (r3(t11.getOptions(), { clickAction: false, dblClickAction: false, wheelAction: false, bounds: false, minScale: 0, maxScale: 1 / 0 }), null === (i9 = t11.getGestures()) || void 0 === i9 || i9.destroy(), null === (s11 = t11.getTween()) || void 0 === s11 || s11.pause());
      }
    }
  ...
  function ke() {
    ...
    for (const e12 of Object.values(U)) null == e12 || e12.destroy();
    if (U = {}, null == r7 || r7.remove(), r7 = void 0, T = void 0, B2 = void 0, z.delete(K), !z.size && (t7(false), document.documentElement.classList.remove(D), J("placeFocusBack") && l8 && !l8.closest("[inert]"))) try {
  ...
  const Oe = { close: Me, destroy: ke, getCarousel: function() {
    ...
    if (a8 && a8.destroy(), z.set(K, Oe), te("init"), (function() {
      for (const [e11, t11] of Object.entries(Object.assign(Object.assign({}, N.Plugins), $.plugins || {}))) if (e11 && !U[e11] && t11 instanceof Function) {
        const n11 = t11();
      ...
      if (a9 && t4(a9)) for (const [e11, t12] of Object.entries(a9)) T.style.setProperty(e11, t12);
      const u5 = J("theme"), d3 = "auto" === u5 ? window.matchMedia("(prefers-color-scheme:light)").matches : "light" === u5;
      T.setAttribute("theme", d3 ? "light" : "dark"), r7.setAttribute("id", `${K}`), r7.addEventListener("keydown", ((e11) => {
        ...
        Z && r8 - Z < 300 ? o9 && k2(e11) : (Z = r8, te("wheel", e11, l9), e11.defaultPrevented || ("close" === n12 ? Me(e11) : "slide" === n12 && B2 && !t2(t12) && (k2(e11), B2[l9 > 0 ? "prev" : "next"]())));
      }), { capture: true, passive: false }), r7.addEventListener("cancel", ((e11) => {
        Me(e11);
      })), t11.append(r7), 1 === z.size && (J("hideScrollbar") && t7(true), document.documentElement.classList.add(D));
      ...
      if (J("closeExisting")) for (const [e11, t11] of z.entries()) e11 !== K && t11.close();
...
function q(e11, t10 = {}) {
  var n10, o9, i9;
  if (!(e11 && e11 instanceof Element)) return;
  let s11, r7, a8, c5, u5 = {};
  for (const [t11, n11] of N.openers) if (t11.contains(e11)) for (const [o10, i10] of n11) {
    let n12;
    if (o10) {
      for (const i11 of t11.querySelectorAll(o10)) if (i11.contains(e11)) {
        n12 = i11;
        break;
      }
      if (!n12) continue;
    ...
    for (const [o11, d4] of i10) {
      ...
      i11 && (r7 = t11, a8 = n12, s11 = i11, c5 = o11, r3(u5, d4 || {}));
    }
  }
  if (!r7 || !c5 || !s11) return;
  const d3 = r3({}, I, t10, u5, { triggerEl: s11 });
  ...
  if (false === d3.groupAll) {
    const e12 = d3.groupAttr, t11 = e12 && s11 ? s11.getAttribute(`${e12}`) : "";
    f3 = e12 && t11 ? f3.filter(((n11) => n11.getAttribute(`${e12}`) === t11)) : [s11];
  }
  if (!f3.length) return;
  ...
  if (p2) {
    ...
    if (e12 && f3.indexOf(e12) > -1) return;
  }
...
var N = { Plugins: { Hash: f2 }, version: "6.1.5", openers: /* @__PURE__ */ new Map(), bind: function(e11, n10, o9, i9) {
  ...
  e11 instanceof Element && (s11 = e11), t(e11) && t(n10) ? (l8 = e11, a8 = n10) : t(n10) && t(o9) ? (l8 = n10, a8 = o9) : t(n10) ? a8 = n10 : t(e11) && (a8 = e11), "object" == typeof n10 && (c5 = n10 || {}), "object" == typeof o9 && (c5 = o9 || {}), "object" == typeof i9 && (c5 = i9 || {}), (function(e12, t10, n11, o10 = {}) {
    if (!(e12 && e12 instanceof Element && n11)) return;
    const i10 = N.openers.get(e12) || /* @__PURE__ */ new Map(), s12 = i10.get(t10) || /* @__PURE__ */ new Map();
    if (s12.set(n11, o10), i10.set(t10, s12), N.openers.set(e12, i10), 1 === i10.size && e12.addEventListener("click", N.fromEvent), 1 === N.openers.size) for (const e13 of Object.values(N.Plugins)) {
      const t11 = e13.setup;
      "function" == typeof t11 && t11(N);
    }
  })(s11, l8, a8, c5);
}, close: function(e11 = true, ...t10) {
  if (e11) for (const e12 of z.values()) e12.close(...t10);
  else {
  ...
  let e11;
  for (; e11 = N.getInstance(); ) e11.destroy();
  for (const e12 of N.openers.keys()) e12.removeEventListener("click", N.fromEvent);
  N.openers.clear();
  ...
  if (t10.closest(".fancybox__container.is-hiding")) return k2(e11), void e11.stopPropagation();
  const o9 = t10.closest("[data-fancybox-delegate]") || void 0;
  if (o9) {
    const e12 = o9.dataset.fancyboxDelegate || "", i9 = document.querySelectorAll(`[data-fancybox="${e12}"]`), s11 = parseInt(o9.dataset.fancyboxIndex || "", 10) || 0;
    t10 = i9[s11] || i9[0], r3(n10, { delegateEl: o9, startIndex: s11 });
  }
  return q(t10, n10);
  ...
  if (!e8()) return;
  let s11 = document.body, l8 = null, a8 = "[data-fancybox]", c5 = {};
  e11 instanceof Element && (s11 = e11), t(e11) && t(n10) ? (l8 = e11, a8 = n10) : t(n10) && t(o9) ? (l8 = n10, a8 = o9) : t(n10) ? a8 = n10 : t(e11) && (a8 = e11), "object" == typeof n10 && (c5 = n10 || {}), "object" == typeof o9 && (c5 = o9 || {}), "object" == typeof i9 && (c5 = i9 || {});
  for (const [e12, t10] of N.openers) for (const [n11, o10] of t10) for (const [t11, i10] of o10) if (e12 === s11 && n11 === l8) {
    const e13 = s11.querySelector((n11 ? `${n11} ` : "") + a8);
    if (e13 && e13.matches(t11)) return N.fromTriggerEl(e13, c5);
  }
  ...
  return Array.from(z.values()).reverse().find(((e12) => {
    if (e12.getState() !== _.Destroyed) return e12;
  })) || void 0;
}, getSlide: function() {
  var e11;
  ...
  e11 instanceof Element && (i9 = e11), t(e11) && t(n10) ? (s11 = e11, l8 = n10) : t(n10) && t(o9) ? (s11 = n10, l8 = o9) : t(n10) ? l8 = n10 : t(e11) && (l8 = e11), (function(e12, t10, n11) {
    if (!(e12 && e12 instanceof Element && n11)) return;
