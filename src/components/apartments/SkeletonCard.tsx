    ...
    <div className="flex flex-1 flex-col gap-3 p-5">
      <div className="flex items-start justify-between gap-3">
        <div className="flex-1 space-y-2">
          <div className="h-6 w-3/4 rounded bg-bg-muted" />
          <div className="h-4 w-1/2 rounded bg-bg-muted" />
        </div>
        <div className="h-6 w-20 rounded-full bg-bg-muted" />
      </div>
      <div className="flex items-center justify-between gap-4">
        <div className="space-y-1">
          <div className="h-8 w-24 rounded bg-bg-muted" />
          <div className="h-4 w-16 rounded bg-bg-muted" />
        </div>
        <div className="h-10 w-28 rounded-xl bg-bg-muted" />
      </div>
    </div>
  </article>
);
