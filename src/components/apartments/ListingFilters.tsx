...
const ListingFilters: React.FC<ListingFiltersProps> = ({
  ...
  <div className="flex flex-col gap-4 rounded-2xl bg-transparent p-4 sm:flex-row sm:items-end sm:justify-between">
    <div className="grid flex-1 grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
      <label className="flex flex-col gap-1 text-sm font-semibold text-text-primary">
        ...
        <input
          ...
          className="w-full rounded-lg px-3 py-2 text-base bg-transparent text-text-primary focus:border-cta-primary focus:outline-none focus:ring-1 focus:ring-cta-primary"
        />
      </label>
    ...
    <div className="flex flex-col gap-3 sm:w-64">
      <label className="flex items-center justify-between text-sm font-semibold text-text-primary">
        ...
        <input
          ...
          className="h-5 w-5 rounded text-accent-primary focus:ring-cta-primary"
        />
      </label>
