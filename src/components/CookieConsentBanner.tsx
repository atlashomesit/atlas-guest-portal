        ...
        <div className="flex flex-col md:flex-row md:items-center gap-4">
          ...
          <div className="flex flex-row gap-2 md:flex-col md:items-stretch shrink-0">
            <button
              type="button"
              onClick={onReject}
              className="px-4 py-3 rounded-xl border border-border-subtle text-text-primary font-semibold hover:border-primary flex-1 md:flex-none"
            >
            ...
            <button
              type="button"
              onClick={onAccept}
              className="px-4 py-3 rounded-xl bg-primary text-[var(--text-contrast)] font-semibold hover:shadow-level2 flex-1 md:flex-none"
            >
              Accept all
            </button>
          </div>
