...
const ChatbotPlaceholder = ({ enableHideUnfinishedChatbot = false }: ChatbotPlaceholderProps) => {
  if (enableHideUnfinishedChatbot) {
    return (
      <div className="rounded-2xl border border-[color-mix(in_srgb,var(--border-subtle)_80%,transparent)] bg-[color-mix(in_srgb,var(--bg-muted)_92%,#f9f6f1_12%)] p-[var(--drawer-card-padding-block,0.75rem)] shadow-inner">
