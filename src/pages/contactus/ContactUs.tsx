        ...
        <section>
            ...
            <div className="w-full bg-gradient-to-r from-[#1a1a2e] to-[#16213e] py-8">
                <div className="max-w-6xl mx-auto px-4 flex items-center gap-6">
                    <div className="hidden md:block w-24 h-24 rounded-xl overflow-hidden shadow-lg flex-shrink-0">
                        <img 
                            src="https://atlashomestorage.blob.core.windows.net/listing-images/501/cover.jpg" 
                            alt="Penthouse" 
                            className="w-full h-full object-cover"
                        />
                    </div>
                    <div className="flex-1">
                        <h2 className="text-2xl md:text-3xl font-bold text-white mb-2">Experience Luxury Living</h2>
                        <p className="text-gray-300 text-sm mb-4">Discover our premium penthouse with stunning views and exclusive amenities.</p>
                        <a 
                            href="/properties/501" 
                            className="inline-block bg-[#FFD700] text-black font-semibold px-6 py-2 rounded-full hover:bg-[#FFC107] transition"
                        >
                            View Penthouse
                        </a>
                    </div>
