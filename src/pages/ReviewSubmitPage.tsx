      ...
      <div className="max-w-lg mx-auto px-4 sm:px-6 py-10 space-y-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="rounded-2xl border border-border-subtle bg-bg-surface p-5 space-y-3">
            ...
            {/* TASK-2072: 16 MB photo upload limit */}
            <p className="text-xs text-text-secondary">JPEG, PNG, WebP, or GIF — up to 16 MB each. Help future guests see what your stay looked like.</p>
            <input
              type="file"
