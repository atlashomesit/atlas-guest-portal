...
- Runtime config is loaded via `/.well-known/atlas-runtime-config.json` at app startup. Ensure the Pages Function is deployed so the endpoint responds before the app bootstraps.
