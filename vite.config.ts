  ...
  server: {
    ...
    headers: {
      ...
      "Content-Security-Policy":
        `default-src 'self'; script-src 'self' 'nonce-${devCspNonce}' https://checkout.razorpay.com https://api.razorpay.com https://*.razorpay.com https://static.cloudflareinsights.com https://maps.googleapis.com; script-src-elem 'self' 'nonce-${devCspNonce}' https://checkout.razorpay.com https://api.razorpay.com https://*.razorpay.com https://static.cloudflareinsights.com https://maps.googleapis.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com data:; img-src 'self' data: https: http://127.0.0.1:* http://localhost:* https://maps.gstatic.com https://*.googleapis.com; connect-src 'self' http://127.0.0.1:* http://localhost:* https://checkout.razorpay.com https://api.razorpay.com https://*.razorpay.com https://cloudflareinsights.com https://api.atlaspms.in https://devapi.atlaspms.in https://qaapi.atlaspms.in https://maps.googleapis.com https://*.googleapis.com; frame-src https://checkout.razorpay.com https://api.razorpay.com https://*.razorpay.com https://www.google.com https://www.google.com/maps https://maps.googleapis.com; frame-ancestors https: http:`,
    },
    proxy: {
